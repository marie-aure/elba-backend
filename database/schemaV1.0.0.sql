...
CREATE TABLE `test` (
  ...
  `onetomany_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKacekbcjsc7ol60v63lll05o1f` (`onetomany_id`),
  CONSTRAINT `FKacekbcjsc7ol60v63lll05o1f` FOREIGN KEY (`onetomany_id`) REFERENCES `liaison_test` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-03-03 17:57:24
